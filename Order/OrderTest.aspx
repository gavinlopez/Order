...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="form-bg-color">
            ...
            <asp:DropDownList ID="coffeeType" runat="server" CssClass="inputs">
                <asp:ListItem Value="120" Text="Classic Americano">Classic Americano</asp:ListItem>
                <asp:ListItem Value="130" Text="Classic Cappuccino">Classic Cappuccino</asp:ListItem>
                <asp:ListItem Value="160" Text="Iced Cappuccino">Iced Cappuccino</asp:ListItem>
                <asp:ListItem Value="160" Text="Classic Latte">Classic Latte</asp:ListItem>
                <asp:ListItem Value="160" Text="Vanilla Latte">Vanilla Latte</asp:ListItem>
                <asp:ListItem Value="180" Text="Caramel Latte">Caramel Latte</asp:ListItem>
                <asp:ListItem Value="180" Text="Mocha Latte">Mocha Latte</asp:ListItem>
            </asp:DropDownList>
