    ...
    public partial class menu : System.Web.UI.Page
    {
        ...
        protected void clickAmericano(object sender, EventArgs e)
        {
            ...
            menuContent.InnerHtml = "<div class='tm-product'>" +
                                        ...
                                        "<div class='tm-product-price'>" +
                                            "<a href = '#' class='tm-product-price-link tm-handwriting-font'>₱120</a>" +
                                        "</div>" +
                                    "</div>";
        }
        ...
        protected void clickCappuccino(object sender, EventArgs e)
        {
            ...
            menuContent.InnerHtml = "<div class='tm-product'>" +
                                        ...
                                        "</div>" +
                                        "<div class='tm-product-price'>" +
                                            "<a href = '#' class='tm-product-price-link tm-handwriting-font'>₱130</a>" +
                                        "</div>" +
                                    "</div>" +
                                    ...
                                    "<div class='tm-product'>" +
                                        ...
                                        "</div>" +
                                        "<div class='tm-product-price'>" +
                                            "<a href = '#' class='tm-product-price-link tm-handwriting-font'>₱160</a>" +
                                        "</div>" +
                                    "</div>";
        }
        ...
        protected void clickLatte(object sender, EventArgs e)
        {
            ...
            menuContent.InnerHtml = "<div class='tm-product'>" +
                                    ...
                                    "<div class='tm-product'>" +
                                        ...
                                        "</div>" +
                                        "<div class='tm-product-price'>" +
                                            "<a href = '#' class='tm-product-price-link tm-handwriting-font'>₱180</a>" +
                                        "</div>" +
                                    "</div>" +
